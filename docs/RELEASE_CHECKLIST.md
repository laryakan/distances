...
- [x] **No inactive travel zones created**: Gates, SHCon, accelerators, and highways are preserved
- [x] **Hazard sectors fully excluded**: Cluster_27 (Void), Cluster_605 (Darkness), Cluster_500 (Avarice 1-3), Cluster_113, Cluster_104_Sector001 (Terran radiation)
...
- [x] **lib/awk/emit_sectors.awk**: Sector scaling (DLC-aware)
...
2. **No AI/jobs overhaul**: Out of scope; this mod only handles map/GOD diffs
3. **No mod conflict detection**: End user responsible for load order
