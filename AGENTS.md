...
For complete project documentation, consult:
- `README.md` - User guide and feature overview
- `docs/RELEASE_CHECKLIST.md` - Verification checklist
- `docs/DOCUMENTATION_AUDIT.md` - Detailed audit report
- `docs/RESERVED_CODE.md` - Explanation of reserved/future code

This file (AGENTS.md) provides quick-start information. For deeper technical context or troubleshooting, refer to the docs directory.
